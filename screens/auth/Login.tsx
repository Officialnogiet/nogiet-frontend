            ...
            <form className="space-y-6" onSubmit={handleSignIn}>
              <div className="space-y-1.5">
                ...
                <input
                  type="email"
                  required
                  className="w-full px-4 py-3 rounded-lg border transition-all outline-none bg-white border-gray-200 text-gray-900 placeholder-gray-300 focus:ring-1 focus:ring-[#009688]"
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-lg border transition-all outline-none tracking-widest bg-white border-gray-200 text-gray-900 placeholder-gray-300"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between pt-2">
                <label className="flex items-center gap-2 cursor-pointer select-none">
                  <div className="relative flex items-center justify-center">
                    ...
                    <div className="w-4 h-4 rounded text-white flex items-center justify-center transition-all border bg-gray-100 border-gray-300 peer-checked:bg-[#009688] peer-checked:border-[#009688]">
